...
LOCAL_DIR = r'E:\Qoder_workspace\weread-challenge-selenium\docs\rk3566-oect1-2-fnOS-deploy'
...
0 0 * * * cd {dir} && docker compose up app-1 -d && (sleep 4200 && docker compose stop app-1 && docker restart selenium-weread-challenge-selenium-oect1) &
0 6 * * * cd {dir} && docker compose up app-1 -d && (sleep 4200 && docker compose stop app-1 && docker restart selenium-weread-challenge-selenium-oect1) &
0 13 * * * cd {dir} && docker compose up app-1 -d && (sleep 4200 && docker compose stop app-1 && docker restart selenium-weread-challenge-selenium-oect1) &
0 19 * * * cd {dir} && docker compose up app-1 -d && (sleep 4200 && docker compose stop app-1 && docker restart selenium-weread-challenge-selenium-oect1) &
# weread-multi: liujl3016
10 1 * * * cd {dir} && docker compose up app-2 -d && (sleep 4200 && docker compose stop app-2 && docker restart selenium-weread-challenge-selenium-oect1) &
10 7 * * * cd {dir} && docker compose up app-2 -d && (sleep 4200 && docker compose stop app-2 && docker restart selenium-weread-challenge-selenium-oect1) &
10 14 * * * cd {dir} && docker compose up app-2 -d && (sleep 4200 && docker compose stop app-2 && docker restart selenium-weread-challenge-selenium-oect1) &
10 20 * * * cd {dir} && docker compose up app-2 -d && (sleep 4200 && docker compose stop app-2 && docker restart selenium-weread-challenge-selenium-oect1) &
# weread-multi: jpx155
20 2 * * * cd {dir} && docker compose up app-3 -d && (sleep 4200 && docker compose stop app-3 && docker restart selenium-weread-challenge-selenium-oect1) &
20 8 * * * cd {dir} && docker compose up app-3 -d && (sleep 4200 && docker compose stop app-3 && docker restart selenium-weread-challenge-selenium-oect1) &
20 15 * * * cd {dir} && docker compose up app-3 -d && (sleep 4200 && docker compose stop app-3 && docker restart selenium-weread-challenge-selenium-oect1) &
20 21 * * * cd {dir} && docker compose up app-3 -d && (sleep 4200 && docker compose stop app-3 && docker restart selenium-weread-challenge-selenium-oect1) &
# weread-multi: jpx181
30 3 * * * cd {dir} && docker compose up app-4 -d && (sleep 4200 && docker compose stop app-4 && docker restart selenium-weread-challenge-selenium-oect1) &
30 9 * * * cd {dir} && docker compose up app-4 -d && (sleep 4200 && docker compose stop app-4 && docker restart selenium-weread-challenge-selenium-oect1) &
30 16 * * * cd {dir} && docker compose up app-4 -d && (sleep 4200 && docker compose stop app-4 && docker restart selenium-weread-challenge-selenium-oect1) &
30 22 * * * cd {dir} && docker compose up app-4 -d && (sleep 4200 && docker compose stop app-4 && docker restart selenium-weread-challenge-selenium-oect1) &
